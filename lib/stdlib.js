...
function greenlight_internal_md5(data) {
	return greenlight_internal_crypto.createHash("MD5").update(data).digest("hex");
}
...
function greenlight_internal_array_diff(array1, array2){
	return array1.filter(item => !array2.includes(item));
}

function greenlight_internal_array_diff_symmetric(array1, array2){
	var result = [];
...
function greenlight_internal_array_intersect(array1, array2){
	return array1.filter(item => array2.includes(item));
}
...
function greenlight_internal_bin(input) {
